...
export default function Input<TFieldValues extends FieldValues = FieldValues>({
  ...
  register,
  rules,
  classNameInput = 'outline-none border-2 rounded-md focus:border-gray-500 border-gray-300 w-full p-3 focus:shadow-md',
  classNameError = 'mt-1 text-red-600 min-h-[1.25rem] text-sm',
  classNameEye = 'absolute top-3 right-3 h-5 w-5 cursor-pointer',
  ...rest
}: Props<TFieldValues>) {
